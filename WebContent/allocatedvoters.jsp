...
<div class="main-container">
    ...
    <div class="search-section">
        ...
        <div class="filter-row">
            ...
            <div class="filter-group">
                ...
                <select class="filter-select" id="assemblyFilter">
                    ...
                    <option value="Thiruvetriyur">Thiruvetriyur</option>
            ...
            <div class="filter-group">
                ...
                <input type="text" class="filter-select" id="mobileFilter" placeholder="Search by mobile number...">
            </div>
        </div>
        ...
        <div class="search-actions">
            ...
            <button class="btn-search" onclick="filterVoters()">
