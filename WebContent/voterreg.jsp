            ...
            <div class="form-group">
                ...
                <div class="input-with-icon">
                    <select id="subject" name="subject" class="form-control" required>
                        ...
                        <option id="sub1" value=""></option>
                        <option id="sub2" value=""></option>
                        <option id="sub3" value=""></option>
                        <option id="sub4" value=""></option>
                    </select>
...
function populateSubjects() {
    ...
    if (course === "BSc") {
        sub1.textContent = "Physics";
        sub1.value = "Physics";
        sub2.textContent = "Chemistry";
        sub2.value = "Chemistry";
        sub3.textContent = "Mathematics";
        sub3.value = "Mathematics";
        sub4.textContent = "Biology";
        sub4.value = "Biology";
    } else if (course === "BCom") {
        sub1.textContent = "Accounting";
        sub1.value = "Accounting";
        sub2.textContent = "Economics";
        sub2.value = "Economics";
        sub3.textContent = "Business Studies";
        sub3.value = "Business Studies";
        sub4.textContent = "Statistics";
        sub4.value = "Statistics";
    } else {
        sub1.textContent = "";
        sub1.value = "";
        sub2.textContent = "";
