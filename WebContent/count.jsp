...
<body>
    <div class="main-container">
        ...
        try {
            ...
            ResultSet rs = st.executeQuery("SELECT count(id) FROM vote.votes where statu='Voted' and party='"+dis+"' and ass='"+ass+"' and cname='"+email+"'");
            while(rs.next()) {
                total = rs.getInt(1);
            }
            
            ResultSet rs2 = st.executeQuery("SELECT * FROM vote.votes where statu='Voted' and party='"+dis+"' and ass='"+ass+"' and cname='"+email+"'");
            ...
            while(rs2.next()) {
                candidateName = rs2.getString(2);
                partyName = rs2.getString(6);
                assembly = rs2.getString(5);
        ...
        <div class="candidate-info">
            ...
            <div class="info-grid">
                ...
                <div class="info-item">
                    ...
                    <span class="info-value"><%= assembly %></span>
                </div>
                <div class="info-item">
        ...
        <div class="stats-container">
            ...
            <div class="stat-card">
                ...
                <div class="stat-number">
                    <%
                        ResultSet totalVotesRs = st.executeQuery("SELECT count(id) FROM vote.votes where statu='Voted' and ass='"+ass+"'");
            ...
            <div class="stat-card">
                ...
                <div class="stat-number">
                    <%
                        ResultSet maxVotesRs = st.executeQuery("SELECT MAX(vote_count) FROM (SELECT COUNT(id) as vote_count FROM vote.votes WHERE statu='Voted' and ass='"+ass+"' GROUP BY cname) as votes");
                        int maxVotes = 0;
                        if(maxVotesRs.next()) {
        ...
        <div class="results-card">
            ...
            <div class="table-responsive">
                <table class="results-table">
                    ...
                    <tbody>
                        <%
                        ResultSet rs1 = st.executeQuery("SELECT * FROM vote.votes where statu='Voted' and party='"+dis+"' and ass='"+ass+"' and cname='"+email+"'");
                        while(rs1.next()) {
                            sno = sno + 1;
