...
public class voterapply extends HttpServlet {
    ...
    private String detectFaceToken(byte[] imageBytes) throws Exception {
        ...
        return null; // IMPORTANT: handled safely in doPost
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try (Connection con = dbconn.create()) {
            ...
            String sql =
                ...
                "(studentname, studentmail, studentcourse, studentsub, pic, status, votekey, Edate, face_token) " +
                "VALUES (?,?,?,?,?,?,?,?,?)";
            ...
            ps.setString(7, "");
            ps.setString(8, "");
            ps.setString(9, faceToken); // ✅ NEVER NULL NOW
