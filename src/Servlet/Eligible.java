...
public class Eligible extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            // ✅ FETCH IMAGE USING COLUMN INDEX (FIX)
            ...
            if (rs.next()) {
                studentPhoto = rs.getBytes(1); // ✅ image column
            } else {
            ...
            ps.setBytes(5, symbolBytes); // Now symbol column can store the full image
